...
.tracker__bubble:nth-child(10), .tracker__bubble:nth-child(12),
	.tracker__bubble:nth-child(13) {
	background: rgba(244, 68, 46, 0.5);
}

.tracker__bubble:nth-child(17), .tracker__bubble:nth-child(18),
	.tracker__bubble:nth-child(19), .tracker__bubble:nth-child(22),
	.tracker__bubble:nth-child(23) {
	background: rgba(239, 184, 186, 0.5);
}

.tracker__bubble:nth-child(27), .tracker__bubble:nth-child(29),
					...
					<ul class="navbar-nav ml-auto">
						<li class="dropdown nav-item"><a href="#"
							...
							<div class="dropdown-menu dropdown-menu-left">
								<a href="http://localhost:8000/donghang/analysis"
									class="dropdown-item"><i class="ion-ios-apps mr-2"></i> 기본
									분석 </a> <a href="http://localhost:8000/donghang/data"
					...
					<div class="notebook__inner">
						...
						<div class="expenses">
							...
							<div class="expenses__box">
								<span class="expenses__title">[처분일자]</span><span
									class="expenses__amount">${ punishlist[0].	gnt_no }</span>
							</div>
							<div class="expenses__box">
								<span class="expenses__title">[법적근거]</span><span
									class="expenses__amount">${ punishlist[0].	bas_law }</span>
							</div>
							<div class="expenses__box">
								<span class="expenses__title">[처분내용]</span><span
									class="expenses__amount">${ punishlist[0].	dispo_ctn }</span>
							</div>
							<div class="expenses__box">
								<span class="expenses__title">[처분기간]</span><span
									class="expenses__amount">2</span>
							</div>
